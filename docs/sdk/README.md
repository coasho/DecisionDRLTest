...
- Headers: `include/fsim/*.h` (C++17; the `{.field = ...}` designated initialisers in these pages are C++20 sugar - assign the fields instead in C++17). Only these are stable; anything under `src/` may change.
