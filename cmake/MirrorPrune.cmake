# Script mode: cmake -DSRC=<dir> -DDEST=<dir> [-DKEEP=<relpath;...>] -P MirrorPrune.cmake
#
...
# makes DEST a mirror of SRC while still copying only what changed. KEEP
# names files the install puts into DEST from elsewhere, such as the
# README beside the maps, so they are not deleted only to be copied back.
...
foreach(_f IN LISTS _dest)
    if(NOT EXISTS "${SRC}/${_f}" AND NOT _f IN_LIST KEEP)
        file(REMOVE "${DEST}/${_f}")
